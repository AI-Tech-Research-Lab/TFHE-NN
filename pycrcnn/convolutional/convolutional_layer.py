...
class ConvolutionalLayer:
    ...
    def __call__(self, t):
        t = apply_padding(self.HE, t, self.padding)
    ...
    def relu(self, elem):
        comp = elem > self.HE.encode(0)
        return TFHEValue(self.HE.vm.gate_mux(comp,  elem.value, elem.vm.gate_constant([[0] for i in range(self.n_bits)])), elem.vm, elem.n_bits)
